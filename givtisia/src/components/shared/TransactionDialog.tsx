...
export function TransactionDialog({
  ...
  const transactionExplorerUrl = transactionResult.transactionPointer
    ? `https://browser.testnet.partisiablockchain.com/transactions/${transactionResult.transactionPointer.identifier}`
    : "";
  const campaignExplorerUrl = `https://browser.testnet.partisiablockchain.com/contracts/${campaignId}?tab=state`;
